...
(define tests
  (test-suite
   ...
   ;;(check-equal? (eval-exp (ifgreater (int 5) (int 1) (int 100) (begin (print "should not print") (int 0)))) (int 100) "ifgreater test2")
   ...
   (check-equal? (eval-exp (call (closure (list (cons "y" (int 100))) (fun #f "x" (add (var "x") (var "y")))) (int 1))) (int 101) "call test 2")
   (check-equal? (eval-exp (call (closure '() (fun "f" "x" (ifgreater (var "x") (int 0) (call (var "f") (add (var "x") (int -1))) (int 100)))) (int 3))) (int 100) "call test 3")
